...
else
{
	...
	<li class="diggbox digg_good" onmousemove="this.style.backgroundPosition=\'left bottom\';" onmouseout="this.style.backgroundPosition=\'left top\';" onclick="postDigg(\'good\','.$id.')">
	<i class="icon_like"></i>顶('.$row['goodpost'].')
           
        </li>
        <li class="diggbox digg_bad" onmousemove="this.style.backgroundPosition=\'right bottom\';" onmouseout="this.style.backgroundPosition=\'right top\';" onclick="postDigg(\'bad\','.$id.')"><i class="icon_bad"></i> 踩('.$row['badpost'].')</li>
            
        
		
		<li class="diggbox"><i class="icon_share"></i>
		<div id="bdshare" class="bdshare_b" style=" float:right; height:30px; padding-top:10px;text-align:right;line-height: 12px;">分享</div>
		</li>
		</ul>';
}
AjaxHead();
