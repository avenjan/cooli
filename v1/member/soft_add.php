...
'$color','$writer','$source','$litpic','$pubdate','$senddate','$mid','$description','$keywords'); ";
    ...
    if(defined('UC_API') && @include_once DEDEROOT.'/api/uc.func.php')
    {
        //推送事件
        $feed['icon'] = 'thread';
        $feed['title_template'] = '<b>{username} 在网站共享了一首音乐</b>';
    ...
    $msg = "
        您可以可以继续选择以下操作：<br/>
        <a href='soft_add.php?cid=$typeid'><u>继续发布新歌</u></a>
        &nbsp;&nbsp;
        <a href='$artUrl' target='_blank'><u>立即浏览</u></a>
        &nbsp;&nbsp;
        <a href='soft_edit.php?channelid=$channelid&aid=$arcID'><u>返回修改</u></a>
        &nbsp;&nbsp;
        <a href='content_list.php?channelid={$channelid}'><u>已发布内容管理</u></a>
        ";
    $wintitle = "成功发布歌曲！";
    $wecome_info = "音乐管理::发布新歌";
    $win = new OxWindow();
    $win->AddTitle("成功发布歌曲：");
    $win->AddMsgItem($msg);
