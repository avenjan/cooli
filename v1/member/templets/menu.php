    ...
    <div id="mcpsub">
      ...
      <div id="menuBody">
      	...
      	{
      	?>
        <h2 class="menuTitle" onclick="menuShow('menuFirst')" id="menuFirst_t"><b></b>内容管理</h2>
        <ul id="menuFirst">
        <?php
        //是否启用文章投稿
        ...
        ?>
          ...
          <li class="photo"><a href="../member/content_list.php?channelid=2" title="管理图集"><b></b>图集</a><a href="../member/album_add.php" class="act" title="新建图集">新建</a></li>
	        ...
	        {
	        ?>
          <li class="soft"><a href="../member/content_list.php?channelid=3" title="管理我发布的音乐"><b></b>我的音乐</a><a href="../member/soft_add.php" title="发布新歌"class="act">发布新歌</a></li>
          <?php
           }
           ?>
        </ul>
      ...
      ?>
        ...
        <ul id="menuFirst">
        	<li class="icon mystow"><a href="../member/mystow.php"><b></b>我的播放器</a></li>
        <?php
      ...
      ?>
      <?php //  <!--<h2 class="menuTitle"><b class="showMenu"></b>操作主菜单项</h2> --> ?>
      </div>
