...
else if($dopost=='save')
{
    ...
    $msg = "
    　　请选择你的后续操作：
    <a href='soft_add.php?cid=$typeid'><u>继续发布音乐</u></a>
    &nbsp;&nbsp;
    <a href='$arcUrl' target='_blank'><u>查看该音乐</u></a>
    &nbsp;&nbsp;
    <a href='archives_do.php?aid=".$arcID."&dopost=editArchives'><u>继续修改</u></a>
    &nbsp;&nbsp;
    <a href='catalog_do.php?cid=$typeid&dopost=listArchives'><u>已发音乐件管理</u></a>
    &nbsp;&nbsp;
